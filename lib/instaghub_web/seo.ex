...
defmodule InstaghubWeb.SEO do
  ...
  defp get_sports_seo(page) do
    title = "Instaghub.com - A instagram viewer, you can find all instagram posts about sports, sexy women, animal, games, food, hot tv shows in instaghub.com!"
    description = "Find hot users, hashtags, posts about women, animal, game, foods on instagram. Instaghub.com is your instagram viewer and it doesn't need login!"
  ...
  def get_user_seo(page) do
    try do
      title = page.username <> "'s instagram user's photos and videos - Instaghub.com"
  ...
  def get_tag_seo(page) do
    try do
      title = page.name <> "'s instagram tag's photos and videos - Instaghub.com"
  ...
  def get_post_seo(page) do
    try do
      title = page.owner.username <> "'s instagram tag's photos and videos - Instaghub.com"
